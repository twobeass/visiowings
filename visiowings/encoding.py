...
def get_encoding_from_document(document: Any, debug: bool = False) -> str | None:
...
def resolve_encoding(document: Any, user_codepage: str | None = None, debug: bool = False) -> str:
